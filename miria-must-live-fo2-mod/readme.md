...
* It wouldn't be strange if TWO people had power armour in the Enclave oil rig. So as long as Miria is doing everything the choosen one is (Wearing power armour mostly) no one gets hostile.

* It wouldn't be strange if TWO people were recruits wandering the Navarro base. You need to go through the trap door in the gas station, but then no one gets hostile there anymore either.
...
From the [The Almost Ultimate Fallout 2 Guide On Navarro](https://lemmings19.github.io/fallout-2-walkthrough/original_source.html#navarro):
...
From the [The Almost Ultimate Fallout 2 Guide On The Enclave](https://lemmings19.github.io/fallout-2-walkthrough/original_source.html#enclave):
